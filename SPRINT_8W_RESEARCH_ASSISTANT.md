...
每天只抓一个主目标，保证能持续，不追求一天塞满所有内容。

| 时间块 | 时间 | 当天产物 |
|---|---:|---|
| 输入：论文 / 文档 / 视频 / 源码 | 40 min | 看懂一个小问题 |
| 输出：代码 / 笔记 / 表格 / 图 | 60 min | 留下一个可展示产物 |
| GitHub 收尾 | 20 min | commit + push + 写清楚下一步 |

每天最低标准：

- 改一个文件。
- 留下一段有用内容。
- commit message 写清楚今天做了什么。

如果当天很忙，30 分钟也可以，只要补一个小笔记或修一个小 TODO。
